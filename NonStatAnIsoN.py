        ...
        if self.grad:
            ...
            if self.verbose:
                if self.truth is not None:
                    ...
                    "vz = %2.2f"%(np.mean(np.abs(par[108:135])-np.abs(self.truth[108:135]))),"\u03C1_1 = %2.2f"%(np.mean(par[135:162]-self.truth[135:162])),"\u03C1_2 = %2.2f"%(np.mean(par[162:189]-self.truth[162:189])), "\u03C3 = %2.2f"%(par[189]-self.truth[189]))
                else:  
