    ...
    for(int j = 0; j < numY; j++){
        for(int i = 0; i < numX; i++){
            for (int m = 0; m < numZ; m++){
                ...
                val[idx + 2] = hy*hy/hz*H[k][4][2][2] - hy/4.0*(H[k][1][2][0] - H[k][0][2][0]) - hx/4.0*(H[k][3][2][1] - H[k][2][2][0]);
                //x
                ...
                val[idx + 6] = hx*hz/hy*H[k][3][1][1] - hx/4.0*(H[k][5][1][2] - H[k][4][1][2]) - hz/4.0*(H[k][1][1][0] - H[k][0][1][0]);
                //z and x
